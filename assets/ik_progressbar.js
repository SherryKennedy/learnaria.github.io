;(function ( $, window, document, undefined ) {
		//Activity 7 only chrome vox for progrssbar , create instr. how to operate bar with screen reader and keyboard
	...
	Plugin.prototype.init = function () { // initialization function
		...
		//Activity 7: add attributes, keyboard not initially focusable 	
		this.element
			.attr({
				'id': id,
	...
	Plugin.prototype.getValue = function() {
		...
		var value;
		//Activity 7, replace data value which receives valuew of pb
		//use aria-valuenow attrib with screen reader
	...
	Plugin.prototype.setValue = function(n) {
		...
		this.element
		//Activity 7, remove data value, use attr from aria-value now
			/*.data({ // inaccessible
				'value': parseInt(val) 
			}) 
      ;*/
	...
	//Activity 7, plugin onkeydonw function
	/**
