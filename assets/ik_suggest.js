...
var pluginName = "ik_suggest",
	defaults = {//Activity 5, define instructions
	...
	Plugin.prototype.init = function () {
      ...
      //Activity 5, attr to polite to announce and role so in landmark list
      .attr({
        'role': 'region',
        'aria-live': 'polite'
       })
    ...
    //Activity 5, cb receives focus when instructions read
    ...
    //Activity 5, switch, up/down arrow operability
      switch (event.keyCode) {
         case ik_utils.keys.down: // select next suggestion from list   
          ...
          //Acitivity 5, break from default
          break;
        }
	};
    ...
    //Activity 5, Add to suggestion box, instructions when they are avail.
